...
const Inten1 = 'UserOnboarding';
const intet2 = 'DatosUsuario';
...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
    ...
    function welcome(agent) {
        agent.add(`Welcome to my agent!, All I need is a country, year, and color for a great story.`);
    ...
    function UserOnboarding(agent){
        const [color, nation, year] = [agent.parameters['color'], agent.parameters['geo-country'],
    ...
    function DatosUsuario(agent){
        const [nombre, edad, nacionalidad, cedula, genero, ] = [agent.parameters['nombre'], agent.parameters['edad']]
    ...
    intentMap.set('UserOnboarding', UserOnboarding);
    intentMap.set('DatosUsuario', DatosUsuario);
